...
<div class="container">
  <div class="card">
    <h2><button class="login-button" name="course" value="">Computer Science and Engineering - CSE</button></h2>
    <p>240 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="">Information Technology - IT</button></h2>
    <p>118 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="">Mechanical Engineering - MECH</button></h2>
    <p>51 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="">Electronics and Communication Engineering - ECE</button></h2>
    <p>34 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="CIV">CIVIL Engineering - CIV</button></h2>
    <p>60 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="">Electrical and Electronics Engineering - EEE</button></h2>
    <p>67 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="">Computer Science and Engineering in Cyber Security - CIC</button></h2>
    <p>60 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="">Computer Science and Engineering in IOT</button></h2>
    <p>50 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="">Artificial Intelligance in Data Science - AIDS</button></h2>
    <p>100 Members</p>
  </div>
  <div class="card">
    <h2><button class="login-button" name="course" value="">Artificial Intelligance in Machine Learning - AIML</button></h2>
    <p>50 Members</p>
  </div>
</div>
</form>
