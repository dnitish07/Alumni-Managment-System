                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <span class="float:right">
                                    <a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="index.jsp?page=manage_event" id="new_event">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-sm btn-outline-primary view_event" type="button" data-id="<%= eventId %>">View</button>
                                                <button class="btn btn-sm btn-outline-primary edit_event" type="button" data-id="<%= eventId %>">Edit</button>
                                                <button class="btn btn-sm btn-outline-danger delete_event" type="button" data-id="<%= eventId %>">Delete</button>
                                            </td>
                                        </tr>
                                        <% 
                                            }
