									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<a class="btn btn-sm btn-outline-primary view_forum" href="../index.jsp?page=view_forum&id=<%= forumId %>" target="_blank" data-id="<%= forumId %>">View</a>
												<button class="btn btn-sm btn-outline-primary edit_forum" type="button" data-id="<%= forumId %>">Edit</button>
												<button class="btn btn-sm btn-outline-danger delete_forum" type="button" data-id="<%= forumId %>">Delete</button>
											</td>
										</tr>
										<%
											}
