...
ResultSet rm = null;
   ...
   try {
      ...
      // Execute Query
      rs = stmt.executeQuery("SELECT COUNT(*) FROM `2024`");
...
%>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2023`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2022`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2021`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2020`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2019`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2018`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2017`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2016`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2015`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2014`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2013`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2012`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2011`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2010`");
...
%></p>
        ...
        <div class="card">
            ...
            <p><%try {
    stmt = con.createStatement();
    rs = stmt.executeQuery("SELECT COUNT(*) FROM `2009`");
