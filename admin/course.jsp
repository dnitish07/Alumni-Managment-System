										...
										%>
													<tr>
														...
														<td class="text-center">
															<button class="btn btn-sm btn-primary edit_course" type="button" data-id="<%= rs.getInt("id") %>" data-course="<%= rs.getString("course") %>">Edit</button>
															<button class="btn btn-sm btn-danger delete_course" type="button" data-id="<%= rs.getInt("id") %>">Delete</button>
														</td>
													</tr>
										<%
												}
